                ...
                <div class="panel panel-primary col-md-6 col-md-offset-3">
                    <div class="row col-md-12">
                        ...
                        <form id="login-form" action="controllers/registrationController.php" method="post" role="form" style="display: block;">
                            ...
                            <div class="form-group" style="margin-top: 25px;">
                                <label>Email :</label>
                                <input type="email" name="email" id="username" class="form-control" placeholder="Username" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="confirm_password" id="password" tabindex="2" class="form-control" placeholder="Password" required>
                            </div>
