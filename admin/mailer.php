...
class Mailing
{
	function mail($mailto, $mailSub, $type, $id = null)
	{
		if ($type === 'accept') {
			  ...
			  <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
				<tr>
				  <td class="content-cell" align="center">
					<p class="f-fallback sub align-center">&copy; 2019 Pet Care. All rights reserved.</p>
				  </td>
				</tr>
			  </table>
			</td>
						  ...
						  <td class="attributes_content">
							<table width="100%" cellpadding="0" cellspacing="10" role="presentation">
							  <tr>
								<td class="attributes_item">
								  <span class="f-fallback">
			<strong>Sorry, can not verify! We can not find your BMDC register number !</strong>
		  </span>
								</td>
							  </tr>
							</table>
...
';
		...
		$mail->Port = 465; // or 587
		$mail->IsHTML(true);
		$mail->Username = "petcare261@gmail.com";
		$mail->Password = "PETcare_0202";
